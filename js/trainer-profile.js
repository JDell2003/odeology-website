(() => {
  ...
  function buildStandalonePreviewSrcdoc(rawHtml = '', { editable = false, viewportMode = 'responsive', desktopWidth = 1920 } = {}) {
    ...
    const bridgeStyle = editable
      ? '<style id="standalone-bridge-style">html,body,*{scrollbar-width:none;-ms-overflow-style:none}*::-webkit-scrollbar{width:0;height:0}[data-standalone-selected="1"]{outline:2px solid #2563eb !important;outline-offset:2px !important;}[data-standalone-selected="1"][data-standalone-rim-hover="1"][data-standalone-rim-cursor="n"]{cursor:n-resize !important;}[data-standalone-selected="1"][data-standalone-rim-hover="1"][data-standalone-rim-cursor="s"]{cursor:s-resize !important;}[data-standalone-selected="1"][data-standalone-rim-hover="1"][data-standalone-rim-cursor="e"]{cursor:e-resize !important;}[data-standalone-selected="1"][data-standalone-rim-hover="1"][data-standalone-rim-cursor="w"]{cursor:w-resize !important;}[data-standalone-selected="1"][data-standalone-rim-hover="1"][data-standalone-rim-cursor="ne"]{cursor:ne-resize !important;}[data-standalone-selected="1"][data-standalone-rim-hover="1"][data-standalone-rim-cursor="nw"]{cursor:nw-resize !important;}[data-standalone-selected="1"][data-standalone-rim-hover="1"][data-standalone-rim-cursor="se"]{cursor:se-resize !important;}[data-standalone-selected="1"][data-standalone-rim-hover="1"][data-standalone-rim-cursor="sw"]{cursor:sw-resize !important;}[data-standalone-selected="1"]:not([data-standalone-rim-hover="1"]){cursor:grab !important;}[data-standalone-selected="1"][data-standalone-dragging="1"]{cursor:grabbing !important;}[data-standalone-editing="1"]{cursor:text !important;}[data-shape-handle]{cursor:move !important}#standalone-context-menu{position:fixed;z-index:2147483647;display:none;min-width:220px;padding:8px;border-radius:14px;background:rgba(15,23,42,.96);border:1px solid rgba(255,255,255,.08);box-shadow:0 20px 48px rgba(0,0,0,.28);backdrop-filter:blur(12px);overflow:visible}#standalone-context-menu[data-menu-drag-hover="1"]{cursor:grab}#standalone-context-menu[data-menu-dragging="1"]{cursor:grabbing}#standalone-context-menu .menu-row{position:relative}#standalone-context-menu button{display:flex;align-items:center;justify-content:space-between;width:100%;min-height:36px;padding:0 12px;border:0;border-radius:10px;background:transparent;color:#f8fafc;font:700 13px/1.2 system-ui,sans-serif;text-align:left;cursor:pointer}#standalone-context-menu button:hover,#standalone-context-menu .menu-row.is-open>button{background:rgba(255,255,255,.08)}#standalone-context-menu hr{margin:6px 0;border:0;border-top:1px solid rgba(255,255,255,.08)}#standalone-context-menu .shape-submenu,#standalone-context-menu .route-submenu{position:absolute;left:calc(100% + 2px);top:-8px;display:none;min-width:190px;padding:8px;border-radius:14px;background:rgba(15,23,42,.98);border:1px solid rgba(255,255,255,.08);box-shadow:0 20px 48px rgba(0,0,0,.28)}#standalone-context-menu .shape-submenu::before,#standalone-context-menu .route-submenu::before{content:\"\";position:absolute;left:-22px;top:0;bottom:0;width:26px}#standalone-context-menu .shape-submenu{min-width:190px}#standalone-context-menu .route-submenu{width:320px;max-height:min(76vh,520px);padding:14px;gap:12px;flex-direction:column;overflow:hidden}#standalone-context-menu .route-submenu[data-side=\"left\"]{left:auto;right:calc(100% + 2px)}#standalone-context-menu .menu-row.is-open .shape-submenu,#standalone-context-menu .menu-row.is-open .route-submenu{display:flex}#standalone-context-menu .route-submenu-title{font:800 12px/1.2 system-ui,sans-serif;letter-spacing:.08em;text-transform:uppercase;color:#cbd5e1;padding:2px 4px 0}#standalone-context-menu .route-submenu-scroll{display:grid;gap:8px;min-height:0;max-height:none;overflow:auto;padding-right:4px;flex:1 1 auto}#standalone-context-menu .route-submenu-empty{padding:14px;border-radius:14px;background:rgba(255,255,255,.03);border:1px dashed rgba(255,255,255,.1);font:600 12px/1.5 system-ui,sans-serif;color:#94a3b8}#standalone-context-menu button.route-submenu-item{display:block;width:100%;min-height:0;padding:13px 14px;border-radius:14px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.06);text-align:left}#standalone-context-menu button.route-submenu-item strong{display:block;margin:0 0 5px;font:700 13px/1.35 system-ui,sans-serif;color:#f8fafc;white-space:normal;word-break:break-word}#standalone-context-menu button.route-submenu-item span{display:block;font:500 11px/1.4 system-ui,sans-serif;color:#94a3b8;white-space:normal;word-break:break-word}#standalone-context-menu button.route-submenu-item:hover{background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.12)}#standalone-context-menu .route-submenu-footer{display:grid;gap:8px;padding-top:10px;border-top:1px solid rgba(255,255,255,.08);flex:0 0 auto;background:linear-gradient(180deg,rgba(15,23,42,0),rgba(15,23,42,.98) 14px,rgba(15,23,42,.98) 100%)}#standalone-context-menu button.route-submenu-add{display:flex;align-items:center;justify-content:center;min-height:42px;border-radius:12px;border:1px dashed rgba(255,255,255,.18);background:rgba(255,255,255,.03);color:#e2e8f0;font:700 12px/1.2 system-ui,sans-serif;cursor:pointer;flex:0 0 auto}#standalone-context-menu button.route-submenu-add:hover{background:rgba(255,255,255,.08)}#standalone-context-menu .route-submenu-form{display:none;gap:8px;flex:0 0 auto}#standalone-context-menu .route-submenu-form.is-active{display:grid}#standalone-context-menu .route-submenu-form input{width:100%;min-height:40px;padding:0 12px;border-radius:10px;border:1px solid rgba(255,255,255,.12);background:rgba(15,23,42,.72);color:#f8fafc;font:600 12px/1.2 system-ui,sans-serif;outline:none}#standalone-context-menu .route-submenu-form input::placeholder{color:#94a3b8}#standalone-context-menu .route-submenu-form input:focus{border-color:rgba(96,165,250,.78);box-shadow:0 0 0 1px rgba(96,165,250,.28)}#standalone-context-menu .route-submenu-create{display:flex;align-items:center;justify-content:center;min-height:40px;border:0;border-radius:10px;background:#2563eb;color:#fff;font:800 12px/1 system-ui,sans-serif;cursor:pointer}#standalone-context-menu .route-submenu-create:hover{background:#1d4ed8}#standalone-hover-delete{position:fixed;z-index:2147483647;display:none;align-items:center;justify-content:center;width:36px;height:36px;border:0;border-radius:999px;background:#dc2626;color:#fff;box-shadow:0 16px 30px rgba(220,38,38,.32);cursor:pointer;transform:translate(-50%,-50%)}#standalone-hover-delete:hover{background:#b91c1c}#standalone-hover-delete svg{width:18px;height:18px;pointer-events:none}#standalone-marquee{position:fixed;z-index:2147483646;display:none;border:1px solid rgba(37,99,235,.9);background:rgba(37,99,235,.12);pointer-events:none}[data-standalone-drop-target="1"]{outline:3px dashed #16a34a !important;outline-offset:-3px !important;}</style>'
      : '';
