...
(function () {
  ...
  var CFG = {
    ...
    questions: [
      // --- WHO ---
      { id: 'audience', section: 'who', path: 'quick', type: 'chips', label: 'Who do you train?', sub: 'Say it the way you’d describe them out loud.', example: 'men over 30 who used to be athletes', lesson: 'Groups, not individuals. “Men over 30” gets watched. “You” gets scrolled.', why: 'Every hook you post names this group. If it’s vague or singular, the hooks fall flat. A specific group makes a specific person stop scrolling.', chips: ['men over 30', 'busy moms', 'beginners in their first year', 'guys who used to be athletes', 'women over 40', 'new lifters', 'shift workers', 'desk-job dads'], inputmode: 'text', validate: 'audience', required: true },
      { id: 'outcome', section: 'who', path: 'quick', type: 'textarea', label: 'What do they get from working with you?', sub: 'One line. The transformation, in their words.', example: 'lose 30 lbs without giving up food they like', why: 'This is the promise in your CTA and your app posts. Say it the way they’d say it, not in coach-speak.', required: true },

      // --- STAND ---
      { id: 'core', section: 'stand', path: 'quick', type: 'text', label: 'What’s the ONE thing you want to be known for?', sub: 'Your angle. The thing you say when others won’t.', example: 'eating enough protein', why: 'You’ll repeat this for years until people associate you with it. Pick the hill you’ll die on.', chips: ['eating enough protein', 'training with intent', 'strength before cardio', 'recovery and sleep', 'consistency over intensity'], required: true },
      ...
      { id: 'mistake1', section: 'stand', path: 'quick', type: 'chips', label: 'Something you constantly see them get wrong.', sub: 'Mistake #1 — be specific.', example: 'they train hard and eat like they didn’t', lesson: 'Specific beats broad. “They train hard and eat like they didn’t” beats “they’re not consistent.”', why: 'Your Mistake posts cycle these for weeks. Specific ones make people feel called out — in a good way.', chips: ['train hard, eat like they didn’t', 'skip protein at breakfast', 'do endless cardio', 'cut calories too hard', 'program-hop every 3 weeks', 'never progress the weight', 'chase soreness not strength', 'skip sleep and wonder why'], required: true },
      { id: 'mistake2', section: 'stand', path: 'quick', type: 'chips', label: 'Another thing they get wrong.', sub: 'Mistake #2.', example: 'they only train what they can see in the mirror', chips: ['only train the mirror muscles', 'weigh themselves daily and panic', 'go all-or-nothing', 'copy influencer workouts', 'never eat enough', 'do too much too soon', 'quit the week before it works'], required: true },
      { id: 'mistake3', section: 'stand', path: 'quick', type: 'chips', label: 'One more they get wrong.', sub: 'Mistake #3.', example: 'they wait to feel motivated', chips: ['wait to feel motivated', 'start over every Monday', 'compare week 1 to someone’s year 5', 'fear carbs', 'skip warm-ups then get hurt', 'train around an injury instead of fixing it'], required: true },
